...
st.set_page_config(page_title="FUTDOOR - Presentación", layout="wide")

# Barra lateral: Menú principal con emojis 📋
st.sidebar.title("📋 Menú de Navegación")
secciones = ["🏠 Introducción", "❌ Problemas Detectados", "✅ Soluciones FUTDOOR", 
...
if seleccion == "🏠 Introducción":
    ...
    st.markdown("""
    **Presentación de proyecto empresarial FUTDOOR**, Una plataforma revolucionaria que transformará el mundo de las transferencias en el fútbol.
    ...
    Conscientes de estas limitaciones, **FUTDOOR** nace con la misión de democratizar el acceso a oportunidades, creando un ecosistema digital que sea:
    ...
    ¡Descubre cómo FUTDOOR está redefiniendo el mercado de fichajes y permitiendo que el talento encuentre el camino hacia nuevas oportunidades!
    """)
...
elif seleccion == "✅ Soluciones FUTDOOR":
    ...
    with tab1:
        ...
        📌 Un agente peruano que representa a un mediocampista defensivo puede subir su perfil a FUTDOOR y, en menos de 72 horas, recibir interés de clubes portugueses o italianos que buscan un jugador con su perfil.
    ...
    with tab2:
        ...
        Cuando un agente sube un jugador a FUTDOOR, la plataforma consulta automáticamente la API para completar su perfil con información validada y actualizada, evitando la carga manual de datos y reduciendo errores.
    ...
    with tab3:
        ...
        st.write("""
        FUTDOOR proporciona herramientas integradas para el seguimiento del rendimiento, gestión de contratos y planificación de transferencias. Automatiza procesos administrativos como recordatorios de renovación de contratos y notificaciones de interés de clubes.
        
        ¿Qué soluciones ofrece FUTDOOR?
    ...
    with tab4:
        ...
        st.write("""
        FUTDOOR lleva la transparencia y seguridad en las transferencias de jugadores a otro nivel mediante el uso de contratos inteligentes y tecnología blockchain. Con estos mecanismos, todos los acuerdos entre clubes y agentes quedan registrados de forma inmutable, eliminando riesgos de incumplimientos, malentendidos o disputas legales.
    ...
    with tab1:
        ...
        st.write("""
        FUTDOOR ofrece una base de datos completa y actualizada de jugadores disponibles, filtrable por posición, edad, nacionalidad, estado contractual y valor de mercado.
    ...
    with tab2:
        ...
        st.write("""
        Los clubes pueden explorar opciones de forma autónoma en FUTDOOR, eliminando llamadas innecesarias y mensajes saturados. La plataforma proporciona un historial detallado de todas las interacciones con agentes y jugadores, facilitando el seguimiento y toma de decisiones.
    ...
    with tab3:
        ...
        st.write("""
        FUTDOOR niveló el campo de juego al proporcionar herramientas profesionales a todos los clubes, independientemente de su tamaño o presupuesto. Ofrece acceso igualitario a información detallada sobre jugadores, eliminando la ventaja injusta de quienes tienen más recursos.
    ...
    **Interpretación:**
    ...
    st.write("""
    Un agente peruano representa a un mediocampista defensivo joven con gran potencial. Sin acceso a redes globales, le resultaba difícil encontrar oportunidades para su jugador. Con **FUTDOOR**:
    ...
    st.write("""
    Un club de 3ª división busca un delantero centro joven con experiencia internacional. Sin herramientas tecnológicas, este proceso sería extremadamente complicado. Con **FUTDOOR**:
    ...
    st.write("""
    Dos agentes, uno de Argentina y otro de México, deciden unir esfuerzos para promover el perfil de un mediocampista ofensivo que ha mostrado un rendimiento sobresaliente. Con **FUTDOOR**:
    ...
    st.write("""
    Una red de agentes de distintos países forma una alianza estratégica para impulsar a jugadores emergentes en mercados globales. Con **FUTDOOR**:
    ...
    st.write("""
    FUTDOOR no es solo una plataforma, es una revolución en el mundo de las transferencias futbolísticas. Al eliminar las barreras estructurales que han mantenido a agentes independientes, clubes pequeños y jugadores emergentes al margen del mercado global, estamos creando un nuevo paradigma en el fútbol profesional.

    Con FUTDOOR, los actores más pequeños ya no tendrán que competir con desventajas tecnológicas, financieras y operativas. Nuestra plataforma empodera a todos los jugadores del ecosistema, permitiendo que accedan a oportunidades globales y transformando su capacidad de negociación.

    ¿Por qué FUTDOOR es la única opción para el futuro del fútbol?
    🔑 Acceso a oportunidades globales: Nunca más un club pequeño o un agente independiente tendrá que conformarse con un mercado limitado. FUTDOOR abre puertas a más de 150 países, conectando a actores del fútbol de todo el mundo.
    ...
    💡 Un ecosistema democrático y accesible: FUTDOOR no es un juego para unos pocos. Es para todos. Desde el agente independiente que busca abrirse camino hasta el club pequeño que aspira a competir con los grandes, todos tienen la misma oportunidad de crecer y prosperar.
    
    El futuro del fútbol es inclusivo, y FUTDOOR es su motor.
    """)

# Footer con emojis
st.write("---")
st.caption("FUTDOOR | 🌍 Donde el talento encuentra oportunidad")
